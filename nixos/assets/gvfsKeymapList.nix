[
    ...
    #       -> If it shows like this: {ftpftpsftpis}://[user@]host[:port]
    ...
    #       -> Example: {ftpftpsftpis}://[user@]host[:port] => ip and port: "ftp://myusername@192.168.1.2:9999" or domain: "ftps://myusername@github.com"
    ...
    #             -> {sftpssh}://[user@]host[:port]. Host can be Host alias in .ssh/config file ip or domain.
